...
- (CGRect)simpleLayoutWithLayoutInfo:(XHSSCollectionViewLayoutInfoModel*)layoutInfo kind:(NSString*)kind indexPath:(NSIndexPath*)indexPath simpleLayoutType:(XHSSCollectionViewFlowLayoutType)layoutType {
    ...
    if ([kind isEqualToString:UICollectionElementKindSectionHeader]) {
        ...
        frame = [self positionForHeaderOrFooterAtIndexPath:indexPath size:headerSize edgeInsets:headerInsets sectionEdgeInsets:sectionEdgeInsets columnCount:columnCount kind:kind];
    } else if ([kind isEqualToString:UICollectionElementKindSectionFooter]) {
        CGSize footerSize = layoutInfo.sectionFooterSize;
        UIEdgeInsets footerInsets = layoutInfo.sectionFooterEdgeInsets;
        UIEdgeInsets sectionEdgeInsets = layoutInfo.sectionEdgeInsets;
        NSInteger columnCount = layoutInfo.columnNumber;
        frame = [self positionForHeaderOrFooterAtIndexPath:indexPath size:footerSize edgeInsets:footerInsets sectionEdgeInsets:sectionEdgeInsets columnCount:columnCount kind:kind];
    } else {
        UIEdgeInsets sectionEdgeInsets = layoutInfo.sectionEdgeInsets;
        ...
        frame = [self positionForItemAtIndexPath:indexPath minimumLineSpacing:minimumLineSpacing minimumInteritemSpacing:minimumInteritemSpacing columnNumber:columnNum originSize:itemSize sectionEdgeInsets:sectionEdgeInsets simpleLayoutType:layoutType];
    }
    ...
    if (shortestIndex < 0) {
        ...
        switch (layoutType) {
            case XHSSCollectionViewFlowLayoutTypeSimpleOriginSize: {
                ...
                self.heightsArr[indexPath.item%columnNumber] = @(originSize.height +minimumLineSpacing);
            }
                break;
            case XHSSCollectionViewFlowLayoutTypeSimpleWidthFitOnly: {
            ...
            case XHSSCollectionViewFlowLayoutTypeSimpleWidthFitHeightRatio: {
                ...
                self.heightsArr[indexPath.item%columnNumber] = @(itemHeightIfRatioStype +minimumLineSpacing);
            }
                break;
            default:
                break;
        ...
        switch (layoutType) {
            case XHSSCollectionViewFlowLayoutTypeSimpleOriginSize: {
                ...
                resultFrame = CGRectMake(startX +(originSize.width +minimumInteritemSpacing)*(shortestIndex),
                                         ...
                                         originSize.width,
                                         originSize.height);
                self.heightsArr[shortestIndex] = @([self.heightsArr[shortestIndex] floatValue] +originSize.height +minimumLineSpacing);
            }
                break;
            case XHSSCollectionViewFlowLayoutTypeSimpleWidthFitOnly: {
            ...
            case XHSSCollectionViewFlowLayoutTypeSimpleWidthFitHeightRatio: {
                ...
                self.heightsArr[shortestIndex] = @([self.heightsArr[shortestIndex] floatValue] +itemHeightIfRatioStype +minimumLineSpacing);
            }
                break;
            default:
                break;
